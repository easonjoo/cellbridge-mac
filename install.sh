#!/bin/bash
# install.sh — DJiPhone Kit / CellBridge-mac 一键安装
#
...
CM_DIR="$REPO_DIR/cellbridge-mac"
FORCE=0
SKIP_GATEWAY=0
...
echo "═══════════════════════════════════════════════"
echo " DJiPhone Kit / CellBridge-mac 安装"
echo " 仓库：$REPO_DIR"
echo "═══════════════════════════════════════════════"
...
then
  ...
  echo "      若你的模块 VID/PID 不同，改 cellbridge-mac/at_pty_bridge.py 顶部的 VID, PID"
fi
